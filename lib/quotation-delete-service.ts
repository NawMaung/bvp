...
export class QuotationDeleteService extends core.Construct {
  constructor(scope: core.Construct, id: string, table: dynamodb.Table) {
    ...
    const quotationDeleteServiceHandler = new lambda.Function(this, 'NM-QuotationDeleteServiceHandler', {
    ...
    const QuotationDeleteServiceApi = new apiGateway.LambdaRestApi(this, 'NM-QuotationDeleteServiceApi', {
